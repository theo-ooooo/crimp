...
**클라이밍 커뮤니티(climbing-community)** 는 국내 클라이머를 대상으로 하는 디지털 홈 플랫폼입니다. 암장·루트 정보, 등반 기록, 크루·파트너 매칭, 피드 커뮤니티, 실내↔아웃도어 연계 가이드를 제공합니다.

- 기획 문서: [Notion — 클라이밍 커뮤니티 서비스 기획서 (v0.1)](https://www.notion.so/345fbab2ef738182b16ad0029cfc5c0c)
