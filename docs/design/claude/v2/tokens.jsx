...
const CrimpTokens = {
  ...
  accents: {
    lime:   { base: '#C9F84B', soft: '#EEFCC1', ink: '#0F1419', flash: '#D8FB6E', on: '#0F1419' },
    blue:   { base: '#3182F6', soft: '#E8F2FE', ink: '#1B64DA', flash: '#5B9BFF', on: '#FFFFFF' },
    orange: { base: '#FF6B35', soft: '#FFEDE5', ink: '#E5521C', flash: '#FF8A5C', on: '#FFFFFF' },
  },
  // Neutral scales
  light: {
    bg:       '#FFFFFF',
